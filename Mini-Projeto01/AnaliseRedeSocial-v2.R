...
setwd("~/Documentos/BigDataAnalytics-R-Azure/Projetos/Mini-Projeto01")
getwd()
...
key <- "UQ3ab08Ylli5IYjbNhIpHxV95"
secret <- "FWRtK4N5w4cdQ3B7eDQ3RzxQXvmu2lcEvtcGhPVGJPpd6EmltO"
token <- "1166479156311449602-xJBMCqg47BknjpoTi8nhZ9V0fShSx5"
tokensecret <- "Hse4CPmlLW46Yt6lDdQv7iB1UTceBg0HMLYvNlyupHt2G"
